    ...
    return (
      <div>
        <div className="container">
          <div
            className="card"
            style={{ marginTop: 2 + "rem", padding: 2 + "rem" }}
          >
                      ...
                      <div className="input-group-prepend">
                        ...
                        <div className="dropdown-menu">
                          ...
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("tipo", "PIBIC")
                            }
                          >
                            PIBIC
                          </a>
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("tipo", "PIBITI")
                            }
                          >
                            PIBITI
                          </a>
                      ...
                      <div className="input-group-prepend">
                        ...
                        <div className="dropdown-menu">
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("area", "Exatas")
                            }
                          >
                            Ciencias Exatas
                          </a>
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("area", "Humanas")
                            }
                          >
                            Ciencias Humanas
                          </a>
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("area", "Biologicas")
                            }
                          >
                            Ciencias Biologicas
                          </a>
                      ...
                      <div className="input-group-prepend">
                        ...
                        <div className="dropdown-menu">
                          ...
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("subarea", "Matematica")
                            }
                          >
                            Matematica
                          </a>
                          <a
                            className="dropdown-item"
                            onClick={() =>
                              this.handleSelection("subarea", "Filosofia")
                            }
                          >
                            Filosofia
                          </a>
