...
const data2 = [
    {
      name: 'Projeto 1', Acessos: 45, amt: 2400,
    },
    {
      name: 'Projeto 2', Acessos: 30, amt: 2210,
    },
    {
      name: 'Projeto 3', Acessos: 20, amt: 2290,
    },
    {
      name: 'Projeto 4', Acessos: 27, amt: 2000,
    },
    {
      name: 'Projeto 5', Acessos: 18, amt: 2181,
    },
    {
      name: 'Projeto 6', Acessos: 23, amt: 2500,
    },
    {
      name: 'Projeto 7', Acessos: 34, amt: 2100,
    },
  ];
...
const renderActiveShape = (props) => {
  ...
  return (
    <g>
      ...
      <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} textAnchor={textAnchor} fill="#333">{`Nº Projetos: ${value}`}</text>
