...
export class verificarInscritos extends Component {
		...
		columns: [
			...
			},
			{
				...
				Cell: (row) => {
					return (
						<div>
							<select name="rank" className="custom-select" id="inputGroupSelect01" defaultValue="none">
	...
	render() {
		return (
			<div>
				<ReactTable data={this.state.data} columns={this.state.columns} defaultSortDesc={true} minRows={12} />
				<div>
					<button
						type="submit"
						value="Submit"
