    ...
    return (
      <Switch>
        ...
        <Route
          ...
          render={this.navbar(
            <CadastroProjeto handleSubmit={this.handleSubmit} />
          )}
        />
        <Route
          path="/Docente/Projetos/relatorios/:id"
          render={this.navbar(
            <RelatorioProjetos projetos={this.state.projetos} />
          )}
        />
        <Route
          path="/Docente/Projetos/edit/:id"
          render={this.navbar(
            <AtualizarProjeto handleEdit={this.handleEdit} />
          )}
        />
        <Route
          exact
          path="/Docente/Projetos/relatorioGeral"
          render={this.navbar(<RelatorioGeral />)}
        />
        <Route
          exact
          path="/Docente/Projetos/:id"
          render={this.navbar(
            <ProjetoItemDocente handleClickEdit={this.handleClickEdit} />
          )}
        />
        <Route
          exact
          ...
          render={this.navbar(
            <CreateEdital handleCreateEdital={this.handleCreateEdital} />
          )}
        />
        <Route
          exact
          ...
          render={this.navbar(
            <EditEdital handleEditEdital={this.handleEditEdital} />
          )}
        />
        <Route
          exact
        ...
        <Route
          ...
          render={this.navbar(
            <VerificarInscritos handleLancarEdital={this.handleLancarEdital} />
          )}
        />
        <Route
          exact
          path="/Docente/profile"
          render={this.navbar(<ProfileDocente />)}
        />
